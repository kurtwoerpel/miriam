    ...
    return (
     ...
     <header className={listview ? "App-header pastpage list-header" : "App-header pastpage" }>
          ...
          <div className='sub-menu'>
            ...
            <div className='search'><div className='search-text baskerville text-small'>Search</div><input type='text'/><div class='letsgo'><svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 75 86.6"><defs></defs><polygon class="cls-1" points="75 43.3 0 0 0 86.6 75 43.3"/></svg></div></div>
          </div>
          <div className=''>
